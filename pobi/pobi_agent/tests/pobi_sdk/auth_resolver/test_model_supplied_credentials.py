...
from pobi_agent.auth_resolver import AuthContextHandler, AuthFlow, AuthType, CredentialsRefs
from pobi_agent.tools.browser.authenticate import _merge_auth_context, _resolve_credentials

# Pull the actual module object (name collision with the tool function).
importlib.import_module("pobi_agent.tools.browser.authenticate")
auth_module = sys.modules["pobi_agent.tools.browser.authenticate"]
...
class TestRefreshWithModelSuppliedCredentials:
    ...
    async def test_explicit_creds_in_refresh_body(
        ...
        from pobi_agent.tools.browser.validate_refresh import refresh_auth_context_service
