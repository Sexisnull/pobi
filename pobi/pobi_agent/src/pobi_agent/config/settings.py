...
from pobi_agent.constants import ROOT_DEADEND_PATH, CACHE_DEADEND_PATH, MODEL_CONFIG_PATH, DEADEND_AGENTS_PATH
...
class Config:
    ...
    Configuration is loaded from ~/.pobi/config.json (preferred) or environment variables.
