# Contributing to Pobi CLI

Thank you for your interest in contributing to Pobi CLI! This document provides guidelines and instructions for contributing.
...
```
pobi/
├── pobi/              # CLI entry point and workflow orchestration
│   └── src/pobi/
├── pobi_agent/            # Core agent framework
│   └── src/pobi_agent/
...
├── pobi_prompts/          # Jinja2 prompt templates
├── pobi_eval/             # Evaluation framework
└── tests/                    # Test suite
```
...
Thank you for contributing to Pobi CLI!
